class FriendsResponse {
  List<ResultsFriends>? results;
  Info? info;

  FriendsResponse({this.results, this.info});

  FriendsResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      results = <ResultsFriends>[];
      json['results'].forEach((v) {
        results!.add(ResultsFriends.fromJson(v));
      });
    }
...
class ResultsFriends {
  ...
  ResultsFriends.fromJson(Map<String, dynamic> json) {
    gender = json['gender'];
